...
<div class="flex flex-col-reverse md:flex-row justify-center items-center">
    <div class="mr-3 w-1/2">
        <p class="text-wrap text-white border-l-2 border-l-indigo-300 pl-2">I'm a Full Stack Developer located in Madison Wisconsin. 
    ...
    <img src="/images/ProfilePic.jpg" alt="Profile Headshot" class="w-1/4 h-1/5 rounded-full shadow-diag shadow-indigo-300 mb-3">
</div>